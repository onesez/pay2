...
<div class="title02">系统调帐</div>
    <form id="rzform">
		<input name="id" value="<?php echo ($userData["id"]); ?>" type="hidden"/>
        <table class="V_tb2">
          <tr class="td1">
            <th>调帐日期：</th>
            <td><input type="text" name="tzriqi" class="V_input3" value="<?php echo ($tzriqi); ?>" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"/></td>
          </tr>
          <tr class="td1">
            <th>被调帐用户名：</th>
            <td>
				<input type="text" name="tzuser" class="V_input3" value="<?php echo ($userData['user_name']); ?>"/>
			</td>
          </tr>
          <tr class="td1">
            <th>被调帐商户名：</th>
            <td><input type="text" name="tzshanghu" class="V_input3" value="<?php echo ($userData['company_name']); ?>"/></td>
          </tr>
          <tr class="td1">
            <th>调帐金额：</th>
            <td>
...
<script type="text/javascript">  
	$(function () {  
		var ajaxurl="<?php echo U('Member/tiaoz');?>";
