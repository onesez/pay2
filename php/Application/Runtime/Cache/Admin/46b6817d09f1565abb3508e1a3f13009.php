...
<script type="text/javascript" src="/pay2/Public/js/myAjax.js"></script>
		...
		<form id="search_form" action="<?php echo U('Closes/lst');?>" method="POST">
				...
				<tr >
					<td>
						...
						<div class="clear:both;"></div>
							...
							<a class="Annkeld1" href="<?php echo U('Closes/expCloses');?>">导出搜索结果</a>	
					</td>
				</tr>
			</table>
		</form>	
	   ...
	   return false;
		...
		layer.confirm('确认删除？', {
			  btn: ['确定','取消'] //按钮
				...
				var ajaxurl="<?php echo U('Closes/delBatch');?>";
				$.ajax({
					type:"POST",
					url:ajaxurl,
					data:{key:chk_value},
