    ...
    <form id="rzform">
        ...
        <table class="V_tb2">
          <tr class="td1">
            <th>用户名：</th>
            <td>
				<input type="text" name="user_name" class="V_input3" value="<?php echo ($_SESSION['user_name']); ?>" disabled="disabled"/>
			</td>
          </tr>
		  <tr class="td1">
            <th>旧密码：</th>
            <td><input type="password" name="nowpassword" class="V_input3"/></td>
          </tr>
		  <tr class="td1">
            <th>新密码：</th>
            <td><input type="password" name="newpassword" class="V_input3"/></td>
          </tr> 
		  <tr class="td1">
            <th>确认密码：</th>
...
<script type="text/javascript">  
	$(function () {  
		var ajaxurl="<?php echo U('Acount/password');?>";
