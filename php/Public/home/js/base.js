...
define('shidai/jquery', function(require, exports, module) {
   ...
   */
      ...
      jQuery.support = function () {
          ...
          div.innerHTML = '  <link/><table></table><a href=\'a.htm\'/*tpa=http://demo4.99huada.com/a*/>a</a><input type=\'checkbox\'/>';
...
define('shidai/ysbbase', function(require, exports, module) {
  ...
  +function ($) {
    ...
    Carousel.prototype.pause = function (e) {
      ...
      if (this.$element.find('.next, .prev.htm'/*tpa=http://demo4.99huada.com/shidai/.next, .prev*/).length && $.support.transition) {
  ...
  +function ($) {
    ...
    if (!$.fn.tooltip) throw new Error('Popover requires tooltip.js'/*tpa=http://demo4.99huada.com/shidai/Popover requires tooltip.js*/)
  ...
  +function ($) {
    ...
    Tab.prototype.show = function () {
      ...
      var hideEvent = $.Event('hide.bs.tab.htm'/*tpa=http://demo4.99huada.com/shidai/hide.bs.tab*/, {
        relatedTarget: $this[0]
      })
      var showEvent = $.Event('show.bs.tab.htm'/*tpa=http://demo4.99huada.com/shidai/show.bs.tab*/, {
      ...
      this.activate($target, $target.parent(), function () {
        $previous.trigger({
          type: 'hidden.bs.tab.htm'/*tpa=http://demo4.99huada.com/shidai/hidden.bs.tab*/,
          relatedTarget: $this[0]
        })
        $this.trigger({
          type: 'shown.bs.tab.htm'/*tpa=http://demo4.99huada.com/shidai/shown.bs.tab*/,
          relatedTarget: $previous[0]
        })
      })
    }
    ...
    function Plugin(option) {
      return this.each(function () {
        var $this = $(this)
        var data  = $this.data('bs.tab.htm'/*tpa=http://demo4.99huada.com/shidai/bs.tab*/)
  
        if (!data) $this.data('bs.tab.htm'/*tpa=http://demo4.99huada.com/shidai/bs.tab*/, (data = new Tab(this)))
        if (typeof option == 'string') data[option]()
      })
    }
